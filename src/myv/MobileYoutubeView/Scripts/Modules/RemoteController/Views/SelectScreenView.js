define(["$", "underscore", "backbone", "marionette", "text!RemoteController/Templates/ChooseScreen-CollectionView.html", "text!RemoteController/Templates/ChooseScreen-ItemView.html", "text!RemoteController/Templates/ChooseScreen-EmptyView.html"], function ($, _, Backbone, Marionette, CollectionTemplate, ItemTemplate, EmptyScreenTemplate) {
    var App = require("App");
